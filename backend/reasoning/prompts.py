...
2. CANADIAN TERMINOLOGY: Lawyers in Canada are NEVER called "attorneys". Always use the term "Lawyer" or "Counsel". Furthermore, use the term "Blackline" instead of "Redline" when referring to document tracked changes.
